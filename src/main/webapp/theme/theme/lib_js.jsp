...
<script src="${pageContext.request.contextPath}/assets/plugins/tooltipster/tooltipster.bundle.min.js"></script>
...
<script src="${pageContext.request.contextPath}/assets/js/angular-locale_es-es.js"></script>
